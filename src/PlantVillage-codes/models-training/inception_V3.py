...
# ✅ Ensure images are resized to (299,299) (InceptionV3 requires 299x299 input size)
IMG_SIZE = (299, 299)
BATCH_SIZE = 16
...
for layer in base_model.layers[:280]:  # 316
...
x = Dense(512, activation='relu')(x)  # Increased neuron count for better learning
...
model_checkpoint = keras.callbacks.ModelCheckpoint(
    "inceptionv3_model.keras",  # Save the best model as .keras file
    monitor='val_loss',  # Monitor validation loss
...
best_model = keras.models.load_model("inceptionv3_model.keras")  # Load model
