...
from tensorflow.keras.applications import VGG16  # Use VGG16
import os
...
for layer in base_model.layers[:14]:  # Adjust number of layers to freeze, total= 16
...
model_checkpoint = keras.callbacks.ModelCheckpoint(
    "vgg16_model.keras",  # Save the best model as .keras file
    monitor='val_loss',  # Monitor validation loss
...
best_model = keras.models.load_model("vgg16_model.keras")  # Load model
